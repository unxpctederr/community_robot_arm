...
#define X_HOME_STEPS 1248 //765 //860 // STEPS FROM X_ENDSTOP TO INITIAL_XYZ FOR UPPER ARM
#define Y_HOME_STEPS 848 //1940 // STEPS FROM Y_ENDSTOP TO INITIAL_XYZ FOR LOWER ARM
#define Z_HOME_STEPS 1968 // STEPS FROM Z_ENDSTOP TO INITIAL_XYZ FOR ROTATION CENTER
...
#define E0_MIN_INPUT 1 // OUTPUT VALUE WHEN SWITCH ACTIVATED - NO: 0, NC: 1

//GEAR RATIO SETTINGS
#define MOTOR_GEAR_TEETH 12.0 // 20.0 FOR 20SFFACTORY BELT VERSION   9.0 FOR FTOBLER GEAR VERSION
#define MAIN_GEAR_TEETH 35.0 // 90.0 FOR 20SFFACTORY BELT VERSION   32.0 FOR FTOBLER GEAR VERSION
